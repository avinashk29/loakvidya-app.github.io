...
var HomepageComponent = /** @class */ (function () {
    ...
    HomepageComponent.prototype.Getuser = function (user) {
        console.log(user);
        this.selectedUser = user;
    };
    HomepageComponent.prototype.onDelete = function (id, name) {
        var _this = this;
        console.log(id);
        if (confirm('Are you sure you want to delete' + ' ' + name)) {
            this.userService.onDelete(id).subscribe(function (user) {
                _this.Users = _this.Users.filter(function (User) { return User.id !== id; });
                _this.selectedUser = [''];
            });
        }
    };
    HomepageComponent.prototype.onUpdate = function (id) {
        this.onEdit = !this.onEdit;
        console.log(this.userForm.value);
        this.userService.onUpdate(this.userForm.value, id).subscribe(function (res) {
            console.log(res);
        });
    };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.onDelete = function (id) {
        return this.http.delete('https://jsonplaceholder.typicode.com/users/' + id);
    };
    UserService.prototype.onUpdate = function (user, id) {
